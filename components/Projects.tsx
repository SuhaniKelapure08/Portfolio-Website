        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md text-justify">
              ...
              Developed an e-commerce web application that has key features including product listings, 
              user authentication, and shopping cart functionality. Implemented responsive front-end 
              components using React.js and Material-UI for a user-friendly interface.Implemented a 
              real-time shopping cart functionality allowing users to add, update, and remove items dynamically.
...
{" "}
            ...
            <div className="text-2xl flex gap-4">
              <a
                ...
                href="https://github.com/SuhaniKelapure08/Amazon-Clone"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            <div>
              ...
              <h3 className="text-2xl font-bold">International Conference Website (Live Project)
              </h3>
            </div>
...
● Contributed to the front-end development and Integrated dynamic content and functionalities to showcase conference details, 
schedules, speakers, and registration information.{" "}
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-textGreen duration-300"
                href="https://github.com/SuhaniKelapure08/Conference-Project-RAEST-CCOEW"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10">
            <div>
              ...
              <h3 className="text-2xl font-bold">ChatBot AI</h3>
            </div>
